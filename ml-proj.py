...
for train_index, test_index in kf.split(x_train):
    ...
    #print("x_train_val | y_train_val\n",len(x_train_val), len(y_train_val), x_train_val, y_train_val)
    #print("x_test_val | y_test_val\n", len(x_test_val), len(y_test_val), x_test_val, y_test_val)
    val_scores.append(model_val_scores(LinearRegression(), x_train_val, x_test_val, y_train_val, y_test_val, 's'))
